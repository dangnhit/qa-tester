...
export type ExplorationCharter = Readonly<{ charterId: string; mission: string; scope: readonly string[]; roles: readonly string[]; heuristics: readonly string[]; safetyRules: readonly string[]; actionBudget: number; timeBudgetMinutes: number; stopConditions: readonly string[] }>;
