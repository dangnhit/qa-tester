...
export function evaluateApproval(
  ...
  if (candidate.steps.some((step) => !validatePlanningAction(step.action).valid)) reasons.push("invalid-dsl");
...
import { validatePlanningAction } from "../contracts/validator.js";
