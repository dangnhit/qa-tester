...
export type EvidenceGap = { artifactType: "evidence-gap"; schemaVersion: "1.0.0"; producerVersion: string; runId: string; reason: string; affectedClaim: string };
...
function gap(reason: string, affectedClaim: string): EvidenceGap {
  return { artifactType: "evidence-gap", schemaVersion: "1.0.0", producerVersion: "0.1.0", runId: "unknown", reason, affectedClaim };
}
